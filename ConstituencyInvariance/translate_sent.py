...
def translate_sent(mt_sys, pred_file, trans_file, s_id, e_id, lan):
    f = open(pred_file, mode="r", encoding='utf-8')
    w = open(trans_file, mode="a", encoding='utf-8')
    line = f.readline()
...
def translate(file_name, s_id, e_id):
    mt_sys = 'youdao'
    ...
    translate_sent(mt_sys, pred_file, translation_file, s_id, e_id, 'zh')
